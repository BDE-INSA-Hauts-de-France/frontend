...
It is possible to receive your UPHF emails directly in your phone or computer mailbox.
...
- **Password:** password chosen for the ENT
- **Port:** 993

**Outgoing server - sending**
- **SMTP server:** smtp.uphf.fr
- **Username:** `numeroENT`@uphf.fr
- **Password:** Password chosen for the ENT
- **Port:** 465
...
- Enter the settings following the blue box instructions
